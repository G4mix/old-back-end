...
public enum ExceptionMessage {
    ...
    TOKEN_DO_NOT_MATCH_EXCEPTION(HttpStatus.UNAUTHORIZED, "Tokens do not match, send same tokens"),
    ...
    USERNAME_INVALID_FORMAT(HttpStatus.BAD_REQUEST,
            "Username has an invalid format. It should contain only alphanumeric characters"),
    ...
    EMAIL_INVALID_FORMAT(HttpStatus.BAD_REQUEST,
            "Email has an invalid format. It should be in the format 'name@gmail.com'"),
