...
public class ParameterValidatorTest {
    ...
    public void validateUsername() {
        ...
        assertThrows(UsernameTooLong.class,
                () -> ParameterValidator.validateUsername("a".repeat(100)));
        assertThrows(UsernameInvalidFormat.class,
                () -> ParameterValidator.validateUsername("user@name"));
    }
    ...
    public void validateEmail() {
        ...
        assertThrows(EmailTooLong.class,
                () -> ParameterValidator.validateEmail("a".repeat(330) + "@gmail.com"));
        assertThrows(EmailInvalidFormat.class,
                () -> ParameterValidator.validateEmail("invalidemail"));
    }
    ...
    public void validatePassword() {
        ...
        assertThrows(PasswordTooLong.class,
                () -> ParameterValidator.validatePassword("a".repeat(129)));
        ...
        assertThrows(PasswordMissingSpecialChar.class,
                () -> ParameterValidator.validatePassword("password1"));
